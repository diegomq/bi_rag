 ...
 */
package br.com.reindex.suri.jsf.util;
...
public abstract class FacesUtils {
	 ...
	 * @param params
	 */
	public static void addMsgToComponent(String componenteId, String msg,
			Object... params) {
	 ...
	 * @param params
	 */
	public static void addMsgWarnToComponent(String componenteId, String msg,
			Object... params) {
	 ...
	 * @param params
	 */
	public static void addMsgErroToComponent(String componenteId, String msg,
			Object... params) {
		addMsgToComponent(componenteId, FacesMessage.SEVERITY_ERROR, msg,
				params);
	}
	 ...
	 * @param params
	 */
	public static void addMsgToComponent(String componentId, Severity severity,
			String msg, Object... params) {
		FacesContext.getCurrentInstance().addMessage(componentId,
				createMessage(severity, msg, params));
	}
	 ...
	 * @return
	 */
	public static FacesMessage createMessage(Severity severity, String msg,
			Object... params) {
		return new FacesMessage(severity, getMessageFromDefaultBundle(msg,
				params), null);
	}
	 ...
	 */
	public static String getMessageFromDefaultBundle(String key,
			Object... params) {
	...
	public static String getMessageFromBundle(String bundleName, String key,
		...
		try {
			...
			Locale locale = context.getViewRoot() != null ? context
					.getViewRoot().getLocale() : context.getExternalContext()
					.getRequestLocale();
			...
			bundle = ResourceBundle.getBundle(
					Constants.SURICATTUS_BUNDLE_BASENAME, locale);
			if (bundle.containsKey(key))
				return formatMsg(bundle.getString(key), params);

			bundle = ResourceBundle.getBundle(
					Constants.PRIMEFACES_BUNDLE_BASENAME, locale);
			if (bundle.containsKey(key))
				return formatMsg(bundle.getString(key), params);

			bundle = ResourceBundle.getBundle(
					Constants.DEFAULT_BUNDLE_BASENAME, locale);
			if (bundle.containsKey(key))
				return formatMsg(bundle.getString(key), params);
